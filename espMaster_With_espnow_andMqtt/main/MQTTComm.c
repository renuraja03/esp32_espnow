...
void mqttPublish(char *dataptr)
{
    ...
    {
        msg_id = esp_mqtt_client_publish(mqttClient, TOPIC_PUB_SENSOR_ACQTICK, dataptr, 0, 0, 0);
...
// char sensorDataBuf[SENSOR_DATA_SIZE];
...
//             sprintf(sensorDataBuf, "%d", sensortick %50);
//             mqttPublish(sensorDataBuf);
//         break;
